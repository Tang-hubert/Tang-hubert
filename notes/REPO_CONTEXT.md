...
### 9. 凌晨研究日誌 Section Takes Priority
If a daily entry already contains `## 凌晨研究日誌`（auto-generated by wim_to_notes_sync.py），all other template sections must be appended **below** it — never above, never replacing it.

**File write order when `## 凌晨研究日誌` exists:**
```
# YYYY-MM-DD

## 凌晨研究日誌        ← Do NOT touch（managed by wim_to_notes_sync.py）
（濃縮研究表格）

## What I Learned      ← Append here
- ...

## Notes               ← Append here
...

## Related Knowledge   ← Append here
...

## Tags               ← Append here
...

## Resources          ← Append here
...
```
...
**Variant B — With 凌晨研究日誌（wim_to_notes_sync.py generated）：**
```markdown
# YYYY-MM-DD

## 凌晨研究日誌
（Auto-generated by wim_to_notes_sync.py — do NOT edit this section）
...
> **Important**: When Variant B applies, always append standard sections BELOW `## 凌晨研究日誌`. Never place any section above it or replace it.
